...
import com.quintus.labs.datingapp.mediapicker.utils.Utils;
...
public class MediaOptions implements Parcelable {
    ...
    private boolean canCaptureMedia;
    ...
    private int maxImageSelectionLimit;
    private int maxVideoSelectionLimit;
    ...
    public boolean canCaptureMedia() {
        return canCaptureMedia;
    }
    ...
    public int getMaxImageSelectionLimit() {
        return maxImageSelectionLimit;
    }

    public int getMaxVideoSelectionLimit() {
        return maxVideoSelectionLimit;
    }
    ...
    private MediaOptions(Builder builder) {
        ...
        this.canCaptureMedia = builder.canCaptureMedia;
        ...
        this.maxImageSelectionLimit = builder.maxImageSelectionLimit;
        this.maxVideoSelectionLimit = builder.maxVideoSelectionLimit;
    ...
    public static class Builder {
        ...
        private boolean canCaptureMedia = false;
         ...
         *
         * @param mediaListSelected Media list selected before.
         */
        public Builder setMediaListSelected(List<MediaItem> mediaListSelected) {
            this.mediaListSelected = mediaListSelected;
            return this;
        }

        public Builder setMaxImageSelectionLimit(int maxImageSelectionLimit) {
            this.maxImageSelectionLimit = maxImageSelectionLimit;
            return this;
        }

        public Builder setMaxVideoSelectionLimit(int maxVideoSelectionLimit) {
            this.maxVideoSelectionLimit = maxVideoSelectionLimit;
            return this;
        }
        ...
        /**
         * Capturing image or video options
         *
         ...
         * @param canSelectMulti
         */
        public Builder canCaptureMedia(boolean canCaptureMedia) {
            this.canCaptureMedia = canCaptureMedia;
            return this;
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(canCaptureMedia ? 1 : 0);
        ...
        dest.writeInt(this.maxImageSelectionLimit);
        dest.writeInt(this.maxVideoSelectionLimit);
    ...
    public MediaOptions(Parcel in) {
        ...
        canCaptureMedia = in.readInt() == 0 ? false : true;
        ...
        this.maxImageSelectionLimit = in.readInt();
        this.maxVideoSelectionLimit = in.readInt();
        aspectX = in.readInt();
        aspectY = in.readInt();
    ...
    public int hashCode() {
        ...
        result = prime * result + (canCaptureMedia ? 1231 : 1237);
    ...
    public boolean equals(Object obj) {
        ...
        if (canSelectMultiPhoto != other.canSelectMultiPhoto)
            return false;
        if (canCaptureMedia != other.canCaptureMedia)
            return false;
