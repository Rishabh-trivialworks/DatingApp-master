package com.quintus.labs.datingapp.mediapicker.activities;
...
import com.quintus.labs.datingapp.mediapicker.CropListener;
import com.quintus.labs.datingapp.mediapicker.MediaItem;
import com.quintus.labs.datingapp.mediapicker.MediaOptions;
import com.quintus.labs.datingapp.mediapicker.MediaSelectedListener;
import com.quintus.labs.datingapp.mediapicker.imageloader.MediaImageLoader;
import com.quintus.labs.datingapp.mediapicker.imageloader.MediaImageLoaderImpl;
import com.quintus.labs.datingapp.mediapicker.utils.MediaUtils;
import com.quintus.labs.datingapp.mediapicker.utils.MessageUtils;
import com.quintus.labs.datingapp.mediapicker.utils.RecursiveFileObserver;
...
public class MediaPickerActivity extends AppCompatActivity implements
    ...
    public void getEventMediaPickerDone(Events.MediaPickerDone mediaPickerDone) {
        onOptionsItemSelected(mDone);
    }
...
//                    ((MediaPickerFragment) activePage).requestReadingExternalStoragePermission();
//                    return true;
//                }
//            } catch (Exception e) {
//                e.printStackTrace();
...
//        mMediaSwitcher.setVisible(false);
    ...
    private void syncMediaOptions() {
        ...
        if (mMediaOptions.canSelectPhoto() && mMediaOptions.canCaptureMedia()) {
            mPhoto.setVisible(true);
        } else {
            mPhoto.setVisible(false);
        }
        if (mMediaOptions.canSelectVideo() && mMediaOptions.canCaptureMedia()) {
...
//                mMediaSwitcher.setIcon(R.drawable.ab_picker_video_2);
                mMediaSwitcher.setTitle(getString(R.string.show_videos));
                break;
            case MediaItem.VIDEO:
//                mMediaSwitcher.setIcon(R.drawable.ab_picker_camera2);
                mMediaSwitcher.setTitle(getString(R.string.show_images));
                break;
            default:
                break;
        }
    ...
    private void returnBackData(final List<MediaItem> mediaSelectedList) {
...
//        takeVideoIntent.putExtra(MediaStore.EXTRA_SIZE_LIMIT, 4194304L);
...
//            returnBackData(((MediaPickerFragment) getActivePage())
//                    .getMediaSelectedList());
//        }
        super.onBackPressed();
    }
