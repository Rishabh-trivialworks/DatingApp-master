...
import com.quintus.labs.datingapp.mediapicker.MediaAdapter;
...
import com.quintus.labs.datingapp.mediapicker.widget.HeaderGridView;
...
public class MediaPickerFragment extends BaseFragment implements
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle bundle) {
        ...
        if (!mMediaOptions.canSelectPhotoAndVideo() && mMediaOptions.canSelectVideo())
            return new CursorLoader(mContext, uri, projects, MediaColumns.MIME_TYPE + "=?", new String[]{"video/mp4"}, order);
        else
    ...
    private void bindData(Cursor cursor) {
        ...
        if (mMediaSelectedList != null) {
            ...
            try {
                ((MediaPickerActivity) getActivity()).getSupportActionBar()
                        .setTitle(mMediaAdapter.getMediaSelectedList().size() == 0 ? "" :
                                mMediaAdapter.getMediaSelectedList().size() + " Selected");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void initView(View view) {
        ...
        // get the view tree observer of the grid and set the height and num cols
        // dynamically
    ...
    public void requestReadingExternalStoragePermission() {
