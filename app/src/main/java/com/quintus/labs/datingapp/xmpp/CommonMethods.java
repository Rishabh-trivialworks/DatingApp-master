...
public class CommonMethods {
    ...
    public void createTable(String tablename) {
        ...
        try {
            ...
            mydb.execSQL("CREATE TABLE IF  NOT EXISTS " + tblname + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, sender TEXT, receiver TEXT, msg TEXT, who TEXT, type TEXT,time TEXT);");
            mydb.close();
        } catch (Exception e) {
    ...
    public void clearChat(String tablename){
        String tblname="'"+tablename+"'";
        try {
            mydb = context.openOrCreateDatabase(DBNAME, Context.MODE_PRIVATE, null);
            mydb.execSQL("delete from "+ tblname);
            mydb.close();
            Log.i("DB", "DELETED");
        } catch (Exception e) {
            Log.i("DBERROR",e.toString());
