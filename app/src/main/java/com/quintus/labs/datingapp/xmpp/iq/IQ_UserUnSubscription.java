 ...
 */
public class IQ_UserUnSubscription extends IQ {
    ...
    public IQ_UserUnSubscription(Jid groupId, int subscriberUserId) {
    ...
    protected IQChildElementXmlStringBuilder getIQChildElementBuilder(IQChildElementXmlStringBuilder xml) {
        ...
        xml.halfOpenElement("event");
        xml.attribute("node", "urn:xmpp:mucsub:nodes:unsubscribers");
        xml.rightAngleBracket();
        xml.closeElement("event");
